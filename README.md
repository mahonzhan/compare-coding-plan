...
| 模型 | 参数量 | Token 消耗比例 |
| :--- | :--- | ---: |
| kimi-k2.5🏞️ |1T A32B| 87.99% |
| gemini-3.1-pro-preview🏞️ || 92.73% |
| deepseek-v3.2 | 671B A37B | 95.30% |
| glm-5.1 |744B A40B| 95.93% |
| qwen-3.5-plus🏞️ |397B A17B| 95.97% |
| gpt-5.4🏞️ || 100.00% |
| mimo-v2-pro🏞️ |1T A42B| 101.18% |
| doubao-seed-2.0-pro🏞️ || 101.50% |
| ⚠️claude-sonnet-4.6🏞️ || 154.11% |
| ⚠️minimax-m2.7 |230B A10B| 179.67% |
